...
public partial class ConcertTicketingDBContext_Read : DbContext
{
    public ConcertTicketingDBContext_Read() {}

    public ConcertTicketingDBContext_Read(DbContextOptions<ConcertTicketingDBContext_Read> options) : base(options) {}
